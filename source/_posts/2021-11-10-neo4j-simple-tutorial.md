...
![](/images/neo4j-simple-tutorial/introduce.png)
...
![](/images/neo4j-simple-tutorial/start.png)
...
SET n.age = null
```
![删除之后](/images/neo4j-simple-tutorial/after-delete.png)
...
RETURN p,c
```
![](/images/neo4j-simple-tutorial/match4.png)
## 改
改主要是使用`SET`关键词
修改a的出生国
```Cypher
...
RETURN p,c
```
![](/images/neo4j-simple-tutorial/set.png)
...
```
![](/images/neo4j-simple-tutorial/front.png)
## 完整代码
```html
<!doctype html>
<html>
